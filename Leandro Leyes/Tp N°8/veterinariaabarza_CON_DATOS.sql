...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-09-2025 a las 23:26:20
...
(1, 'Firulais', 'Macho', 'Canino', 'Labrador', 'Marrón', '2020-05-01', 1, 1),
(2, 'Mishi', 'Hembra', 'Felino', 'Siames', 'Gris', '2019-03-15', 1, 2),
(3, 'Rocky', 'Macho', 'Canino', 'Bulldog', 'Blanco', '2021-01-20', 1, 3),
(4, 'Luna', 'Hembra', 'Canino', 'Caniche', 'Negro', '2018-09-10', 1, 4),
(5, 'Nube', 'Macho', 'Felino', 'Persa', 'Blanco', '2020-07-25', 1, 5),
(6, 'Toby', 'Macho', 'Canino', 'Pastor Alemán', 'Negro', '2019-11-11', 1, 6),
(7, 'Kira', 'Hembra', 'Felino', 'Mestizo', 'Atigrado', '2021-06-05', 1, 7),
(8, 'Simba', 'Macho', 'Canino', 'Golden Retriever', 'Dorado', '2020-02-14', 1, 8),
(9, 'Nala', 'Hembra', 'Felino', 'Bengalí', 'Naranja', '2019-12-01', 1, 9),
(10, 'Max', 'Macho', 'Canino', 'Beagle', 'Tricolor', '2021-04-18', 1, 10);
...
(8, 8, '2024-09-25', 'Limpieza dental', 28.3, 8, 1),
(9, 9, '2024-09-25', 'Plan nutricional', 5.1, 9, 1),
(10, 10, '2024-10-11', 'Tratamiento piel', 12.6, 10, 1);
